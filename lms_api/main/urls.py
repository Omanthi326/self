...
urlpatterns = [
   ...
   # path('chapter/', views.ChapterList.as_view()),
    ...
    path('extract-report-content/', views.submission_content, name='submission-content'),
    path('detailed-comparison/', views.detailed_comparison, name='detailed-comparison'),
